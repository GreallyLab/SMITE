...
## Draw a network ##
SMITEplotModule(test_annotation, which.network=6,layout="fr", label_scale=TRUE)
```
...
SMITEplotModule(test_annotation, which.network=1,layout="fr", goseq=TRUE,label_scale = FALSE)
```