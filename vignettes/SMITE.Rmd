...
test_annotation <- SMITE::makePvalueAnnotation(data=hg19_genes, other_data=list(h3k4me1=h3k4me1), 
...
highScores(test_annotation)
head(test_annotation@score_data@module_output)
