setMethod ("print",
           ...
           function(x,...){
               ...
               if(nrow(exprs(slot(x,"expression")))==0){
                ...
                cat("* Expression data :"); print(pData(slot(x,"expression"))); 
               ...
               if(length(unlist(slot(x,"modifications")))==0){
                   ...
                   for(i in unique(unlist(slot(x,"modifications"))$type)){
                       cat(paste("*", i, "data :")); print(subset(unlist(
                        slot(x,"modifications")),unlist(slot(x,
                        "modifications"))$type==i)); print(paste(i,"has",
                        length(subset(unlist(slot(x,"modifications")),
               ...
               if(nrow(slot(slot(x,"score_data"),"pval_data"))==0){
                ...
                print(paste("Score data has", nrow(slot(slot(x,"score_data"),
                "scores")),"entries"))
               }
               readline()
